...
export default function Blogs() {
  ...
  return (
    <main className="bg-gradient-to-b from-[#0a0a0f] via-[#0f1420] to-[#0a0a0f]">
      ...
      <AnimatedHeader 
        title="Our Blog"
        description="Insights, tutorials, and updates from the world of AI-powered technology and software development."
      />
      ...
      <section className="relative py-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 justify-center mb-12">
            {categories.map((category) => (
              <button
                ...
                className={`px-4 sm:px-6 py-2 rounded-xl font-medium text-sm sm:text-base transition-all duration-300 hover:scale-110 ${
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-400 text-lg">No blogs available yet. Check back soon!</p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                      <span className="text-xs sm:text-sm text-gray-400">By {blog.author}</span>
                      <span className="text-blue-400 text-xs sm:text-sm font-medium group-hover:translate-x-1 transition-transform inline-flex items-center gap-1">
                        Read More
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8">
              <div>
                ...
                <p className="text-gray-300 mb-6 text-sm font-medium leading-relaxed break-words">
                  Alphinex Solutions delivers cutting-edge AI-powered software development and intelligent IT consulting services.
                </p>
